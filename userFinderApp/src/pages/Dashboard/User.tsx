...
const User = (props: any) => {
  ...
  return (
    <div className="p-4 rounded-l w-full ">
      ...
      <div className="dark:bg-[#111111] bg-gray-400 flex items-center justify-around flex-wrap rounded-lg shadow-xl m-4 p-3 text-2xl">
          ...
          <div className="flex flex-wrap hover:text-[#00acee] items-center w-full max-[946px]:justify-center">
            <span className="flex text-lg items-center">
              <svg
                ...
                fill="currentColor"
                className="bi bi-twitter h-6 w-6  dark:text-gray-400 text-gray-700 hover:text-[#00acee]"
                viewBox="0 0 16 16"
              >
